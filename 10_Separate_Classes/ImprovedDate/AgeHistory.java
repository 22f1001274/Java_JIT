public class AgeHistory{
    ...
    public static void printAgeHistory(int personNumber, Date birthDate){
        ...
        System.out.println("Pn " + personNumber + " was born on " + birthDate.toString());
        ...
        while (someBirthday.lessThan(presentDate)) {
            System.out.println("Pn " + personNumber + " was " + ageInSomeYear + " on " + someBirthday.toString());
        ...
        if (someBirthday.equals(presentDate))
            ...
            System.out.println("Pn " + personNumber + " will be " + ageInSomeYear + " on " + someBirthday.toString());
    } // printAgeHistory
