...
public class CalendarHighlight{
    ...
    private static void printMonth(int monthStartDay, int lastDateInMonth, int dateHighlighted){
        ...
        while (nextDateToPrint <= lastDateInMonth || noOfRowsPrintedSoFar < 6) {
            ...
            for (int dayColumnNo = 1; dayColumnNo <= 7; dayColumnNo++){
                ...
                if (dayColumnNo != nextDayColumnToUse || nextDateToPrint > lastDateInMonth)
                    ...
                    printDate(nextDateToPrint, dateHighlighted);
                    nextDayColumnToUse++;
                    nextDateToPrint++;
                } // else
            } // for
    ...
    private static void printDate(int date, int dateHighlighted){
        if (date == dateHighlighted) 
